...
import Models.RAFT_Stereo.core.stereo_datasets as datasets
from Models.RAFT_Stereo.evaluate_stereo import count_parameters, validate_things
...
def sequence_loss(flow_preds, flow_gt, valid, loss_gamma=0.9, max_flow=700):
    ...
    for i in range(n_predictions):
        ...
        # We adjust the loss_gamma so it is consistent for any number of RAFT_Stereo iterations
